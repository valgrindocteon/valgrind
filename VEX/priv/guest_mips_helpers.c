...
extern void cvm_move_to_cop2_helper(ULong rt, UInt imm)
{
   ...
   /* Load Result/Input into AES/SMS4/CAMELLIA Unit */
   ...
   /* Perform CAMELLIA FL Function */
   ASM_VOLATILE_DMTC2(0x115);

   /* Perform CAMELLIA FL^-11 Functio */
   ASM_VOLATILE_DMTC2(0x116);
   ...
   /* Perform One CAMELLIA Round */
   ASM_VOLATILE_DMTC2(0x3114);
...
extern ULong cvm_move_from_cop2_helper(UInt imm)
{
   ...
   /* Load Result/Input from AES/CAMELLIA/SMS4 Unit */
   ASM_VOLATILE_DMFC2(0x100);
   ASM_VOLATILE_DMFC2(0x101);

   /* Load IV from AES/SMS4 Unit */
   ASM_VOLATILE_DMFC2(0x102);
   ASM_VOLATILE_DMFC2(0x103);

   /* Load Key from AES/SMS4 Unit */
